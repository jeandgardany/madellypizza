...
class FillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filling" do
    assert_difference('Filling.count') do
      post fillings_url, params: { filling: { description: @filling.description, name: @filling.name, price: @filling.price } }
    end
  ...
  test "should update filling" do
    patch filling_url(@filling), params: { filling: { description: @filling.description, name: @filling.name, price: @filling.price } }

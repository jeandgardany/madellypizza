...
class FlavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flavor" do
    assert_difference('Flavor.count') do
      post flavors_url, params: { flavor: { description: @flavor.description, name: @flavor.name } }
    end
  ...
  test "should update flavor" do
    patch flavor_url(@flavor), params: { flavor: { description: @flavor.description, name: @flavor.name } }
